...
public class Customer_Menu extends JFrame {
	...
	private JLabel label_click_item;
	...
	private void initGUI() {
		...
		//click item label
		label_click_item = new JLabel("Click on the item you want to customize.");
		label_click_item.setHorizontalAlignment(SwingConstants.CENTER);
		label_click_item.setForeground(Color.WHITE);
		label_click_item.setFont(new Font("Arial", Font.BOLD, 20));
		label_click_item.setBackground(Color.WHITE);
		label_click_item.setBounds(48, 126, 491, 32);
		contentPane.add(label_click_item);
	}//end initGUI
