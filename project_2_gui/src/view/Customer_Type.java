 ...
 * 
 * NOTE: Most of the code in this file is randomly generated by the API tool
 */
...
public class Customer_Type extends javax.swing.JFrame {
	 ...
	 * 
	 * Because code below is generated, no comments are provided in initComponents
	 */
	...
	private void initComponents() {
		...
		label_customer.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				New_Customer view_new_cust = new New_Customer(api_connection);
		...
		label_manager.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				Cust_Sign_In view_return_cust = new Cust_Sign_In(
						api_connection);
		...
		panel_customerLayout.setHorizontalGroup(panel_customerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(panel_customerLayout.createSequentialGroup().addContainerGap()
						.addComponent(label_customer, javax.swing.GroupLayout.DEFAULT_SIZE, 346, Short.MAX_VALUE).addContainerGap()));
		panel_customerLayout.setVerticalGroup(panel_customerLayout
		...
		panel_managerLayout.setHorizontalGroup(panel_managerLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(panel_managerLayout.createSequentialGroup()
						...
						.addContainerGap()));
		panel_managerLayout.setVerticalGroup(panel_managerLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(panel_managerLayout.createSequentialGroup()
						.addContainerGap()
		...
		javax.swing.GroupLayout panel_layoutLayout = new javax.swing.GroupLayout(
				panel_layout);
		panel_layoutLayout.setHorizontalGroup(panel_layoutLayout
				.createParallelGroup(Alignment.LEADING)
				.addGroup(panel_layoutLayout.createSequentialGroup().addGap(97)
				...
				.addGroup(panel_layoutLayout.createSequentialGroup()
						...
						.addGap(110))
				.addGroup(panel_layoutLayout.createSequentialGroup().addGap(39)
		...
		panel_layoutLayout.setVerticalGroup(panel_layoutLayout
				.createParallelGroup(Alignment.LEADING)
				.addGroup(panel_layoutLayout.createSequentialGroup()
						.addContainerGap().addComponent(btnBack)
