...
public class beverageMenu extends JFrame {
	...
	private final JLabel lblEntreeMenu = new JLabel("BEVERAGE MENU");
	...
	private static final int BEVERAGE_MENU_ID = 3;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					beverageMenu frame = new beverageMenu(new DataHelper());
	 ...
	 * Create the frame.
	 */
	public beverageMenu(String first_name, String last_name, String username, String password) {
	 ...
	 */
	public beverageMenu(DataHelper api) {
		if (MENU_HEADER.size() == 0)
		{
			MENU_HEADER.addElement("Name");
			MENU_HEADER.addElement("Price");
	...
	public beverageMenu(DataHelper api, double price) {
		if (MENU_HEADER.size() == 0)
		{
			MENU_HEADER.addElement("Name");
			MENU_HEADER.addElement("Price");
	...
	public beverageMenu(DataHelper api, Vector<String> all_orders, double price) {
		if (MENU_HEADER.size() == 0)
		{
			MENU_HEADER.addElement("Name");
			MENU_HEADER.addElement("Price");
	...
	private void initGUI() {
		...
		pane_menu.setBounds(10, 144, 568, 119);
//		table_menu.setPreferredSize(568,374)
		...
		lblEntreeMenu.setBounds(8, 23, 568, 73);
		...
		panel_1.setBounds(292, 283, 200, 75);
		...
		lblCheckout.setBounds(10, 11, 180, 53);
