...
public class dessertMenu extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					dessertMenu frame = new dessertMenu(new DataHelper());
	 ...
	 * Create the frame.
	 */
	public dessertMenu(String first_name, String last_name, String username, String password) {
	 ...
	 */
	public dessertMenu(DataHelper api) {
		if (MENU_HEADER.size() == 0)
		{
			MENU_HEADER.addElement("Name");
			MENU_HEADER.addElement("Price");
	...
	public dessertMenu(DataHelper api, double price) {
		if (MENU_HEADER.size() == 0)
		{
			MENU_HEADER.addElement("Name");
			MENU_HEADER.addElement("Price");
	...
	public dessertMenu(DataHelper api, Vector<String> all_orders, double price) {
		if (MENU_HEADER.size() == 0)
		{
			MENU_HEADER.addElement("Name");
			MENU_HEADER.addElement("Price");
	...
	private void initGUI() {
		...
		pane_menu.setBounds(10, 144, 568, 64);
//		table_menu.setPreferredSize(568,374)
		...
		panel_1.setBounds(297, 219, 200, 76);
