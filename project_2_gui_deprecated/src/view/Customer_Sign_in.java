...
public class Customer_Sign_in extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Customer_Sign_in
     */
    ...
    private void initComponents() {
        ...
        lblCustomerSignIn = new javax.swing.JLabel();
        ...
        lblCustomerSignIn.setBackground(new java.awt.Color(255, 255, 255));
        lblCustomerSignIn.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        lblCustomerSignIn.setForeground(new java.awt.Color(255, 255, 255));
        lblCustomerSignIn.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblCustomerSignIn.setText("Customer Sign In");
        lblCustomerSignIn.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        	...
        	panel_layoutLayout.createParallelGroup(Alignment.TRAILING)
        		.addGroup(panel_layoutLayout.createSequentialGroup()
        			.addGroup(panel_layoutLayout.createParallelGroup(Alignment.LEADING)
        				.addGroup(panel_layoutLayout.createSequentialGroup()
        					.addGap(174)
        					.addGroup(panel_layoutLayout.createParallelGroup(Alignment.LEADING, false)
        						.addComponent(panel_user, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        						.addComponent(panel_pass, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        						.addComponent(panel_login, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        						.addComponent(label_login_msg, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
        				.addGroup(panel_layoutLayout.createSequentialGroup()
        					.addGap(144)
        					.addComponent(lblCustomerSignIn)))
        ...
        panel_layoutLayout.setVerticalGroup(
        	panel_layoutLayout.createParallelGroup(Alignment.LEADING)
        		.addGroup(panel_layoutLayout.createSequentialGroup()
        			.addGap(35)
        			.addComponent(lblCustomerSignIn, GroupLayout.PREFERRED_SIZE, 75, GroupLayout.PREFERRED_SIZE)
        			.addGap(43)
        			.addComponent(panel_user, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
        			.addGap(27)
        			.addComponent(panel_pass, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
        			.addPreferredGap(ComponentPlacement.RELATED, 32, Short.MAX_VALUE)
        			.addComponent(label_login_msg)
        			.addPreferredGap(ComponentPlacement.UNRELATED)
        			.addComponent(panel_login, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
        			.addGap(36))
        );
	...
	private void panel_loginMouseClicked(java.awt.event.MouseEvent evt) {                                         
        ...
        else if (api_connection.verify_customer(label_username, label_pass) == 2)
        {
            label_login_msg.setText("Successful Sign In");
        }
        // incorrect username/password
        else if (api_connection.verify_customer(label_username, label_pass) == 1)
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Customer_Sign_in.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel lblCustomerSignIn;
